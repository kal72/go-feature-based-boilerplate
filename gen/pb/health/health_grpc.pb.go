...
const (
	...
	HealthService_Ready_FullMethodName = "/health.v1.HealthService/Ready"
)
...
//
// HealthService exposes liveness and readiness probes via gRPC and REST.
// These endpoints are used by Kubernetes, load balancers, and monitoring tools.
type HealthServiceClient interface {
	// Check returns the overall liveness status of the service.
...
func (c *healthServiceClient) Ready(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HealthCheckResponse)
...
func (UnimplementedHealthServiceServer) Ready(context.Context, *HealthCheckRequest) (*HealthCheckResponse, error) {
...
func _HealthService_Ready_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthServiceServer).Ready(ctx, req.(*HealthCheckRequest))
	}
	return interceptor(ctx, in, info, handler)
}
